...
export default function RefreshIcon({ width = '15', height = '15' }: IconProps) {
  return (
    <svg version="1.1" width={width} height={height} viewBox="0 0 512 512" enableBackground="new 0 0 512 512">
      <g>
        <g>
